...
VITE_CAREERNET_API_KEY=커리어넷-open-api-key
```
...
GitHub Pages 배포에서도 커리어넷 대학/학과 데이터를 쓰려면 repository Settings > Secrets and variables > Actions에 `VITE_CAREERNET_API_KEY`도 추가하세요.
